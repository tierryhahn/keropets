...
export class migrationNew1667932901539 implements MigrationInterface {
    name = 'migrationNew1667932901539'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "donations" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "type" character varying(68) NOT NULL, "quantity" character varying(68) NOT NULL, "donatedBy" character varying NOT NULL, "donatedTo" character varying NOT NULL, "donatedAt" date NOT NULL DEFAULT now(), CONSTRAINT "PK_c01355d6f6f50fc6d1b4a946abf" PRIMARY KEY ("id"))`);
